...
# Notes: Optimal Transport with Proximal Splitting
**Author:** Alex Albors Juez  
**Date:** May 13, 2024
...
#### Closed Function
A function is said to be **closed** if its epigraph (area over the curve) is closed. 

#### Proper Convex Function
A function is **proper convex** if it is convex, doesn't attain the value $-\infty$, and is not identically $\infty$.
